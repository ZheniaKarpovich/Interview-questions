...
## 25. Что такое diamond problem (алмаз смерти) в ООП?
...
## 33. Что значит «переключение» (context switch) между процессами и потоками?
...
## 33. Python однопоточный или многопоточный?
...
## 33. Что такое асинхронность и как она реализована в Python?
...
## 50. Что такое контекстный менеджер в Python?
